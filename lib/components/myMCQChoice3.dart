...
class MyMCQChoice3 extends StatefulWidget {
  ...
  @override
  _MyMCQChoiceState3 createState() => _MyMCQChoiceState3();
}
       ...
       width: SizeConfig.blockSizeHorizontal * 65,
        ...
        child: Container(
          ...
          child: RaisedButton(
            ...
            hoverColor: isTappedMCQFlash3 ? MyColor().white : Color.fromRGBO(74, 85, 98, 1.0),
            elevation: 0,
            color: isTappedMCQFlash3 ? MyColor().white : Color.fromRGBO(74, 85, 98, 1.0),
            onPressed: () {
              if(counterSurvey == 0) {
                setState(() {
            ...
            child: Text(widget.choice,
                ...
                style: TextStyle(
                    color: isTappedMCQFlash3 ? MyColor().black : MyColor().white,
